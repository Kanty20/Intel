...
// Coefficients:
// a:
const int A_I =  4;  // <optimize>  4
const int A_F = 26;  // <optimize>  28, 26
...
// b:
const int B_I =  4;  // <optimize>  4
const int B_F = 17;  // <optimize>  28
...
// c:
const int C_I =  4;  // <optimize>  4
const int C_F = 12;  // <optimize>  28
...
///----- komentarze
// zmnieniam C_F bo odpowiada on za liczbę po przecinku
// 28 bitów - bardzo dokładne ale dużo z zasobów bierze
// 24 -||-  -               -||-
// 20 -||-  - dobre i mneij zabiera zasobów
// 16 -||-  -       -||-
// 12 -||-  -       -||-
// 8  -||-  - odpada
// PATRZE NA PLIK COEFF_TABLE.HPP ZE WSPÓŁCZYNNIKAMI 
// a= 2
// b= 11
// c= 16
